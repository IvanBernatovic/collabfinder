  ...
  <div class="py-4 lg:w-2/3 mx-auto">
    <div class="p-6 bg-white rounded-lg">
        ...
        <div class="flex gap-2">
          ...
          <Popover class="relative">
            ...
            <transition enter-active-class="transition duration-200 ease-out" enter-from-class="translate-y-1 opacity-0"
              ...
              <PopoverPanel class="mt-2 bg-white rounded-mdy px-3 py-4 absolute z-10 w-[250px] shadow right-0"
                v-slot="{ close }">
                <div class="flex gap-2">
                  <ShareNetwork network="twitter" :url="projectLink" :title="projectShareTitle"
                  ...
                  <ShareNetwork network="facebook" :url="projectLink" :title="projectShareTitle"
                    :description="projectShareTitle" class="social-icon-wrapper bg-[#4267B2]">
                  ...
                  <ShareNetwork network="linkedin" :url="projectLink" :title="projectShareTitle"
                    :description="projectShareTitle" class="social-icon-wrapper bg-[#0A66C2]">
                  ...
                  <ShareNetwork network="reddit" :url="projectLink" :title="projectShareTitle"
                    :description="projectShareTitle" class="social-icon-wrapper bg-[#FF5700]">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-6" fill="currentColor">
                      <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                      <path
                ...
                <div class="pt-3">
                  <TextInput type="text" disabled :value="projectLink" class="w-full" />
                  <PopoverButton @click="copyLink" class="secondary-btn w-full mt-2">
                    Copy link
                  </PopoverButton>
                </div>
              </PopoverPanel>
      ...
      <div class="flex gap-2 mt-6">
        <PrimaryButton class="flex-1 font-medium rounded" @click="openModal" :disabled="applyDisabled">{{ applyBtnLabel
          }}</PrimaryButton>
      ...
      <div class="mt-8">
        ...
        <article class="text-gray-800 description" v-html="project.description"></article>
      </div>
