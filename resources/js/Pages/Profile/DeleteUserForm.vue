  ...
  <div>
    <form-section>
      ...
      <div>
        ...
        <div class="mt-6 bg-gray-100 dark:bg-gray-800 dark:text-white p-2 flex items-center">
          <svg class="w-16 h-16 ml-1 mr-4" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6.3335 8.33366H7.66683V12.3337H6.3335V8.33366ZM6.3335 5.66699H7.66683V7.00033H6.3335V5.66699Z"
              class="fill-[#495057] dark:fill-gray-200" />
          ...
          <p class="text-darkgrey dark:text-gray-200">
        ...
        <div class="mt-6">
          <UModal v-model:open="confirmingUserDeletion" title="Delete account permanently">
            <button class="secondary-btn" type="button" @click="confirmUserDeletion">
              Delete
            </button>

            <template #body>
              <form @submit.prevent="deleteUser">
                <p class="text-darkgrey dark:text-gray-100">
                ...
                <div class="flex gap-3 mt-4">
                  ...
                  <primary-button :disabled="form.processing">Delete account</primary-button>
                </div>
              </form>
            </template>
          </UModal>
