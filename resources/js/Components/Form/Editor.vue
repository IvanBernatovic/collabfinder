...
const editor = useEditor({
  ...
  editorProps: {
    attributes: {
      class:
        'p-2 border border-gray-200 rounded min-h-[120px] bg-[#F8F9FA] rounded-[4px] focus:bg-white focus:border-[#495057] outline-none transition-all'
    }
  }
})
...
<style lang="postcss">
.editor-btn {
  @apply flex h-6 w-6 justify-center items-center rounded hover:cursor-pointer;
}
