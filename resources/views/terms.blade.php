<x-guest-layout>
    <div id="terms" class="p-6 md:p-12">
        <h2><strong>Terms and Conditions</strong></h2>

        <p>Welcome to CollabFinder.net!</p>

        <p>These terms and conditions outline the rules and regulations for the use of CollabFinder.net's Website,
            located
            at https://collabfinder.net/.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            CollabFinder.net if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <p>We employ the use of cookies. By accessing CollabFinder.net, you agreed to use cookies in agreement with the
            CollabFinder.net's Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, CollabFinder.net and/or its licensors own the intellectual property rights for all
            material on CollabFinder.net. All intellectual property rights are reserved. You may access this from
            CollabFinder.net for your own personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from CollabFinder.net</li>
            <li>Sell, rent or sub-license material from CollabFinder.net</li>
            <li>Reproduce, duplicate or copy material from CollabFinder.net</li>
            <li>Redistribute content from CollabFinder.net</li>
        </ul>
        ...
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. CollabFinder.net does not filter, edit, publish or review Comments prior to their
            presence
            on the website. Comments do not reflect the views and opinions of CollabFinder.net,its agents and/or
            affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted
            by applicable laws, CollabFinder.net shall not be liable for the Comments or for any liability, damages or
            expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
            Comments on
            this website.</p>

        <p>CollabFinder.net reserves the right to monitor all Comments and to remove any Comments which can be
            considered
        ...
        <p>You hereby grant CollabFinder.net a non-exclusive license to use, reproduce, edit and authorize others to
            use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            CollabFinder.net; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you
            must inform us by sending an e-mail to CollabFinder.net. Please include your name, your organization name,
        ...
        <p>No use of CollabFinder.net's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
        ...
        <ul>
            ...
            <li>exclude any of our or your liabilities in case of idea theft of the ideas shared on CollabFinder.net
            </li>
        </ul>
