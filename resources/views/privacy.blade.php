<x-guest-layout>
    <div id="terms" class="p-6 md:p-12">
        <h1>Privacy Policy for CollabFinder.net</h1>

        <p>At CollabFinder.net, accessible from https://collabfinder.net/, one of our main priorities is the privacy of
            our visitors. This Privacy Policy document contains types of information that is collected and recorded by
            CollabFinder.net and how we use it.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in CollabFinder.net. This policy is not
            applicable to any information collected offline or via channels other than this website. Our Privacy Policy
            was created with the help of the <a href="https://www.privacypolicygenerator.info">Privacy Policy
                Generator</a> and the <a href="https://www.generateprivacypolicy.com/#wizard">Free Privacy Policy
                Generator</a>.</p>
        ...
        <p>CollabFinder.net follows a standard procedure of using log files. These files log visitors when they visit
        ...
        <p>Like any other website, CollabFinder.net uses 'cookies'. These cookies are used to store information
        ...
        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on CollabFinder.net, which are sent directly
        ...
        <p>Note that CollabFinder.net has no access to or control over these cookies that are used by third-party
            advertisers.</p>

        <h2>Third Party Privacy Policies</h2>

        <p>CollabFinder.net's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
        ...
        <p>CollabFinder.net does not knowingly collect any Personal Identifiable Information from children under the age
